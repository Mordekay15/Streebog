...
public final class OFB extends Algorithm {
    ...
    public OFB(CipherHolder holder, byte[] key, byte[] initialVector, Padding padding) {
        super(holder, key, initialVector, padding);
    }

    public OFB(CipherHolder holder, byte[] key, byte[] initialVector) {
        super(holder, key, initialVector, null);
    }

    public OFB(CipherHolder holder, byte[] key) {
    ...
    public byte[] encrypt(byte[] data) {
        ...
        for (int i = 0; i < blockNum; i++) {
            ...
            rotateVector(vector, gamma, blockSize);
            blocksProcessed++;
        }

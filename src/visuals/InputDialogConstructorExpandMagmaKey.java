...
public class InputDialogConstructorExpandMagmaKey {
    private static InputDialogConstructorExpandMagmaKey instance;
    private final JComponent parent;

    private InputDialogConstructorExpandMagmaKey(JComponent parent) {
        this.parent = parent;
    }

    public static InputDialogConstructorExpandMagmaKey get(JComponent parent) {
        if (instance == null) {
            instance = new InputDialogConstructorExpandMagmaKey(parent);
        }
        return instance;
    }

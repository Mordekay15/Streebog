...
public class InputDialogConstructorKuznyechikRound {
    private static InputDialogConstructorKuznyechikRound instance;
    private final JComponent parent;

    private InputDialogConstructorKuznyechikRound(JComponent parent) {
        this.parent = parent;
    }

    public static InputDialogConstructorKuznyechikRound get(JComponent parent) {
        if (instance == null) {
            instance = new InputDialogConstructorKuznyechikRound(parent);
        }
        return instance;
    }
